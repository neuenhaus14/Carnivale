...
//import userPageTests from './userPage.test';
...
// // creating new Seq object with testing
// // configuration
...
// // running the 'test' script drops and creates
// // carnivale_test db. Below, a connection is tested,
// // then the models are synced, then the
// // server is started
// before(function () {
//   testDb
//     .authenticate()
...
//   // server.listen(port, () => {
//   //   console.log(`
//   // Test server started at: http://127.0.0.1:${port}
//   // `);
//   // });
// });
