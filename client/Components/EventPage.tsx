          ...
          <Modal show={showAboutModal} onHide={toggleAboutModal}>
            ...
            <Modal.Body>
              <p className='fs-6 lh-sm'>
                ...
                <br />
                <br />
                Discover upcoming live music in New Orleans by selecting a date
                at the bottom of the page. Clicking a gig opens a panel for
                creating a custom event with the gig&apos;s details
                prepopulated, and you can update those details as needed.
                <br />
                <br />
